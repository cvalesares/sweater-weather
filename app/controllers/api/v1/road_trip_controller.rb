class Api::V1::RoadTripController < ApplicationController
  def create
    ...
    if hours_taken == ""
      render json: {data: { id: 'null', type: 'roadtrip', attributes: {start_city: road_trip.start_city, end_city: road_trip.end_city, travel_time: road_trip.travel_time, weather_at_eta: {temperature: "", conditions: ""}}}}
    elsif user.present?
